...
(define-key evil-normal-state-map [down-mouse-2] 'ignore)
(define-key evil-normal-state-map [down-mouse-3] 'ignore)
(define-key evil-normal-state-map [mouse-1] 'ignore)
(define-key evil-normal-state-map [mouse-2] 'ignore)
(define-key evil-normal-state-map [mouse-3] 'ignore)
(define-key evil-normal-state-map [mouse-4] 'ignore)
(define-key evil-normal-state-map [mouse-5] 'ignore)
(define-key evil-normal-state-map [mouse-6] 'ignore)
(define-key evil-normal-state-map [mouse-7] 'ignore)
(define-key evil-normal-state-map [C-down-mouse-1] 'ignore)
(define-key evil-normal-state-map [C-down-mouse-2] 'ignore)
(define-key evil-normal-state-map [C-down-mouse-3] 'ignore)
(define-key evil-normal-state-map [C-mouse-1] 'ignore)
(define-key evil-normal-state-map [C-mouse-2] 'ignore)
(define-key evil-normal-state-map [C-mouse-4] 'ignore)
(define-key evil-normal-state-map [C-mouse-5] 'ignore)
(define-key evil-normal-state-map [C-mouse-6] 'ignore)
(define-key evil-normal-state-map [C-mouse-7] 'ignore)

(define-key evil-visual-state-map [down-mouse-1] 'ignore)
(define-key evil-visual-state-map [down-mouse-2] 'ignore)
(define-key evil-visual-state-map [down-mouse-3] 'ignore)
(define-key evil-visual-state-map [mouse-1] 'ignore)
(define-key evil-visual-state-map [mouse-2] 'ignore)
(define-key evil-visual-state-map [mouse-3] 'ignore)
(define-key evil-visual-state-map [mouse-4] 'ignore)
(define-key evil-visual-state-map [mouse-5] 'ignore)
(define-key evil-visual-state-map [mouse-6] 'ignore)
(define-key evil-visual-state-map [mouse-7] 'ignore)
(define-key evil-visual-state-map [C-down-mouse-1] 'ignore)
(define-key evil-visual-state-map [C-down-mouse-2] 'ignore)
(define-key evil-visual-state-map [C-down-mouse-3] 'ignore)
(define-key evil-visual-state-map [C-mouse-1] 'ignore)
(define-key evil-visual-state-map [C-mouse-2] 'ignore)
(define-key evil-visual-state-map [C-mouse-4] 'ignore)
(define-key evil-visual-state-map [C-mouse-5] 'ignore)
(define-key evil-visual-state-map [C-mouse-6] 'ignore)
(define-key evil-visual-state-map [C-mouse-7] 'ignore)
...
(define-key evil-motion-state-map [mouse-6] 'ignore)
(define-key evil-motion-state-map [mouse-7] 'ignore)
(define-key evil-motion-state-map [C-down-mouse-1] 'ignore)
(define-key evil-motion-state-map [C-down-mouse-2] 'ignore)
(define-key evil-motion-state-map [C-down-mouse-3] 'ignore)
(define-key evil-motion-state-map [C-mouse-1] 'ignore)
(define-key evil-motion-state-map [C-mouse-2] 'ignore)
(define-key evil-motion-state-map [C-mouse-4] 'ignore)
(define-key evil-motion-state-map [C-mouse-5] 'ignore)
(define-key evil-motion-state-map [C-mouse-6] 'ignore)
(define-key evil-motion-state-map [C-mouse-7] 'ignore)

(define-key evil-insert-state-map [down-mouse-1] 'ignore)
(define-key evil-insert-state-map [down-mouse-2] 'ignore)
(define-key evil-insert-state-map [down-mouse-3] 'ignore)
(define-key evil-insert-state-map [mouse-1] 'ignore)
(define-key evil-insert-state-map [mouse-2] 'ignore)
(define-key evil-insert-state-map [mouse-3] 'ignore)
(define-key evil-insert-state-map [mouse-4] 'ignore)
(define-key evil-insert-state-map [mouse-5] 'ignore)
(define-key evil-insert-state-map [mouse-6] 'ignore)
(define-key evil-insert-state-map [mouse-7] 'ignore)
(define-key evil-insert-state-map [C-down-mouse-1] 'ignore)
(define-key evil-insert-state-map [C-down-mouse-2] 'ignore)
(define-key evil-insert-state-map [C-down-mouse-3] 'ignore)
(define-key evil-insert-state-map [C-mouse-1] 'ignore)
(define-key evil-insert-state-map [C-mouse-2] 'ignore)
(define-key evil-insert-state-map [C-mouse-4] 'ignore)
(define-key evil-insert-state-map [C-mouse-5] 'ignore)
(define-key evil-insert-state-map [C-mouse-6] 'ignore)
(define-key evil-insert-state-map [C-mouse-7] 'ignore)
  #+END_SRC
